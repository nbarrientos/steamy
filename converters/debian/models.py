...
class UnversionedSourcePackage(BaseUnversionedPackage, Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "source", self.package)
...
class UnversionedBinaryPackage(BaseUnversionedPackage, Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "binary", self.package)
...
class VersionNumber(Version, Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "version", str(self))
...
class Constraint(Labelable):
  ...
  def asURI(self, base):
    ...
    return composeURI(base, "constraint", postfix)
...
class File(Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "path", self.ancestor.path, self.name)
...
class Directory(Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "path", self.path)
...
class Tag(Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "tag", self.facet, self.tag)
...
class Architecture(SimpleDataHolderResources, Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "arch", self.name)
...
class Section(SimpleDataHolderResources, Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "section", self.name)
...
class Contributor(Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "contributor", self.email)
...
class Human(Contributor, Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "people", self.email)
...
class Team(Contributor, Labelable):
  ...
  def asURI(self, base):
    return composeURI(base, "team", self.email)
...
def composeURI(base, prefix, *args):
  if args:
    return "%s/%s/%s" % (base, prefix, "/".join(args))
  else:
